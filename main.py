...
def get_now_snow_time():
    ...
    # 指定された形式に変換して出力
    formatted_time_rounded = rounded_date_object.strftime('%Y年%m月%d日%H時%M分%S秒')
    # print(formatted_time_rounded)
...
def main():
    ...
    st.info('この情報は気象庁からの情報を取得していますが\n速報値のため正確性は保証できません', icon=None)
